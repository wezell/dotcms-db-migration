...
ALTER TABLE "public"."workflow_action_step" DROP CONSTRAINT "fk_w_action_step_action_id";
ALTER TABLE "public"."workflow_action_step" DROP CONSTRAINT "fk_w_action_step_step_id";
...
ALTER TABLE "public"."workflow_task" DROP CONSTRAINT "fk_workflow_task_language";
...
ALTER TABLE "public"."api_token_issued" DROP CONSTRAINT "api_token_issued_pkey";
...
ALTER TABLE "public"."workflow_action_step" DROP CONSTRAINT "pk_workflow_action_step";
...
ALTER TABLE "public"."relationship" DROP CONSTRAINT "relationship_relation_type_value_key";
