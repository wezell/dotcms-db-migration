...
ALTER TABLE "public"."containers" DROP CONSTRAINT "containers_identifier_fk";
ALTER TABLE "public"."containers" DROP CONSTRAINT "fk8a844125fb51eb";
ALTER TABLE "public"."containers" DROP CONSTRAINT "fk_user_containers";
...
ALTER TABLE "public"."file_asset" DROP CONSTRAINT "file_identifier_fk";
ALTER TABLE "public"."file_asset" DROP CONSTRAINT "fk7ed2366d5fb51eb";
ALTER TABLE "public"."file_asset" DROP CONSTRAINT "fk_user_file_asset";
ALTER TABLE "public"."fileasset_version_info" DROP CONSTRAINT "fk_fil_ver_info_lockedby";
ALTER TABLE "public"."fileasset_version_info" DROP CONSTRAINT "fk_fileasset_version_info_identifier";
ALTER TABLE "public"."fileasset_version_info" DROP CONSTRAINT "fk_fileasset_version_info_live";
ALTER TABLE "public"."fileasset_version_info" DROP CONSTRAINT "fk_fileasset_version_info_working";
...
ALTER TABLE "public"."htmlpage" DROP CONSTRAINT "fk_user_htmlpage";
ALTER TABLE "public"."htmlpage" DROP CONSTRAINT "fkebf39cba5fb51eb";
ALTER TABLE "public"."htmlpage" DROP CONSTRAINT "htmlpage_identifier_fk";
ALTER TABLE "public"."htmlpage" DROP CONSTRAINT "template_id_fk";
ALTER TABLE "public"."htmlpage_version_info" DROP CONSTRAINT "fk_htmlpage_version_info_identifier";
ALTER TABLE "public"."htmlpage_version_info" DROP CONSTRAINT "fk_htmlpage_version_info_live";
ALTER TABLE "public"."htmlpage_version_info" DROP CONSTRAINT "fk_htmlpage_version_info_working";
ALTER TABLE "public"."htmlpage_version_info" DROP CONSTRAINT "fk_page_ver_info_lockedby";
...
ALTER TABLE "public"."virtual_link" DROP CONSTRAINT "fkd844f8ae5fb51eb";
...
ALTER TABLE "public"."abcontact" DROP CONSTRAINT "abcontact_pkey";
ALTER TABLE "public"."ablist" DROP CONSTRAINT "ablist_pkey";
...
ALTER TABLE "public"."bjentry" DROP CONSTRAINT "bjentry_pkey";
ALTER TABLE "public"."bjtopic" DROP CONSTRAINT "bjtopic_pkey";
ALTER TABLE "public"."bjverse" DROP CONSTRAINT "bjverse_pkey";
ALTER TABLE "public"."blogscategory" DROP CONSTRAINT "blogscategory_pkey";
ALTER TABLE "public"."blogscomments" DROP CONSTRAINT "blogscomments_pkey";
ALTER TABLE "public"."blogsentry" DROP CONSTRAINT "blogsentry_pkey";
ALTER TABLE "public"."blogslink" DROP CONSTRAINT "blogslink_pkey";
ALTER TABLE "public"."blogsprops" DROP CONSTRAINT "blogsprops_pkey";
ALTER TABLE "public"."blogsreferer" DROP CONSTRAINT "blogsreferer_pkey";
ALTER TABLE "public"."blogsuser" DROP CONSTRAINT "blogsuser_pkey";
ALTER TABLE "public"."bookmarksentry" DROP CONSTRAINT "bookmarksentry_pkey";
ALTER TABLE "public"."bookmarksfolder" DROP CONSTRAINT "bookmarksfolder_pkey";
...
ALTER TABLE "public"."calevent" DROP CONSTRAINT "calevent_pkey";
ALTER TABLE "public"."caltask" DROP CONSTRAINT "caltask_pkey";
...
ALTER TABLE "public"."containers" DROP CONSTRAINT "containers_pkey";
...
ALTER TABLE "public"."cyrususer" DROP CONSTRAINT "cyrususer_pkey";
ALTER TABLE "public"."cyrusvirtual" DROP CONSTRAINT "cyrusvirtual_pkey";
...
ALTER TABLE "public"."dlfileprofile" DROP CONSTRAINT "dlfileprofile_pkey";
ALTER TABLE "public"."dlfilerank" DROP CONSTRAINT "dlfilerank_pkey";
ALTER TABLE "public"."dlfileversion" DROP CONSTRAINT "dlfileversion_pkey";
ALTER TABLE "public"."dlrepository" DROP CONSTRAINT "dlrepository_pkey";
...
ALTER TABLE "public"."file_asset" DROP CONSTRAINT "file_asset_pkey";
ALTER TABLE "public"."fileasset_version_info" DROP CONSTRAINT "fileasset_version_info_pkey";
...
ALTER TABLE "public"."htmlpage" DROP CONSTRAINT "htmlpage_pkey";
ALTER TABLE "public"."htmlpage_version_info" DROP CONSTRAINT "htmlpage_version_info_pkey";
...
ALTER TABLE "public"."igfolder" DROP CONSTRAINT "igfolder_pkey";
ALTER TABLE "public"."igimage" DROP CONSTRAINT "igimage_pkey";
...
ALTER TABLE "public"."journalarticle" DROP CONSTRAINT "journalarticle_pkey";
ALTER TABLE "public"."journalstructure" DROP CONSTRAINT "journalstructure_pkey";
ALTER TABLE "public"."journaltemplate" DROP CONSTRAINT "journaltemplate_pkey";
...
ALTER TABLE "public"."mailreceipt" DROP CONSTRAINT "mailreceipt_pkey";
ALTER TABLE "public"."mbmessage" DROP CONSTRAINT "mbmessage_pkey";
ALTER TABLE "public"."mbmessageflag" DROP CONSTRAINT "mbmessageflag_pkey";
ALTER TABLE "public"."mbthread" DROP CONSTRAINT "mbthread_pkey";
ALTER TABLE "public"."mbtopic" DROP CONSTRAINT "mbtopic_pkey";
ALTER TABLE "public"."multi_tree" DROP CONSTRAINT "multi_tree_pkey";
ALTER TABLE "public"."networkaddress" DROP CONSTRAINT "networkaddress_pkey";
...
ALTER TABLE "public"."projfirm" DROP CONSTRAINT "projfirm_pkey";
ALTER TABLE "public"."projproject" DROP CONSTRAINT "projproject_pkey";
ALTER TABLE "public"."projtask" DROP CONSTRAINT "projtask_pkey";
ALTER TABLE "public"."projtime" DROP CONSTRAINT "projtime_pkey";
...
ALTER TABLE "public"."shoppingcart" DROP CONSTRAINT "shoppingcart_pkey";
ALTER TABLE "public"."shoppingcategory" DROP CONSTRAINT "shoppingcategory_pkey";
ALTER TABLE "public"."shoppingcoupon" DROP CONSTRAINT "shoppingcoupon_pkey";
ALTER TABLE "public"."shoppingitem" DROP CONSTRAINT "shoppingitem_pkey";
ALTER TABLE "public"."shoppingitemfield" DROP CONSTRAINT "shoppingitemfield_pkey";
ALTER TABLE "public"."shoppingitemprice" DROP CONSTRAINT "shoppingitemprice_pkey";
ALTER TABLE "public"."shoppingorder" DROP CONSTRAINT "shoppingorder_pkey";
ALTER TABLE "public"."shoppingorderitem" DROP CONSTRAINT "shoppingorderitem_pkey";
...
ALTER TABLE "public"."skin" DROP CONSTRAINT "skin_pkey";
...
ALTER TABLE "public"."virtual_link" DROP CONSTRAINT "virtual_link_pkey";
ALTER TABLE "public"."web_form" DROP CONSTRAINT "web_form_pkey";
ALTER TABLE "public"."wikidisplay" DROP CONSTRAINT "wikidisplay_pkey";
ALTER TABLE "public"."wikinode" DROP CONSTRAINT "wikinode_pkey";
ALTER TABLE "public"."wikipage" DROP CONSTRAINT "wikipage_pkey";
